...
var _ = DescribeTable("Xray new user request error", func(inbound *config.InboundConfigType, user *v2ray.UserType, expErr error) {
	v := &v2ray.XrayServer{}
...
var _ = DescribeTable("Xray rm user request error", func(inbound *config.InboundConfigType, user *v2ray.UserType, expErr error) {
	v := &v2ray.XrayServer{}
